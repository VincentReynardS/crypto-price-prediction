...
def run(
    ...
    comet_ml.login(
        # api_key=comet_ml_api_key, # I ran $uv run comet login on the terminal to paste my API key
        # I suspect you can pass it directly here, for a full programatic access (e.g. if you run this thing in a Github action)
